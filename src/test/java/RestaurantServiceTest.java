...
class RestaurantServiceTest {
    ...
    public void restaurant_adding_for_test(){
        restaurant = service.addRestaurant("Amelie's cafe","chennai",LocalTime.parse("10:30:00"),LocalTime.parse("22:00:00"));
        service.addRestaurant("Chocos","chennai",LocalTime.parse("09:30:00"),LocalTime.parse("22:00:00"));
